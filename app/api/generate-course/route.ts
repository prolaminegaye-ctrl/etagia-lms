...
- Activité variée et engageante : choisis le type d'activité le plus adapté au module parmi mise_en_situation, jeu_de_role, etude_de_cas, defi_chronometre, brainstorming_flash, simulation_decision — ne répète jamais le même type sur deux modules consécutifs. Chaque activité a une consigne actionnable immédiatement. Pour les activités qui gagnent à être chronométrées (defi_chronometre notamment, ou toute activité où une contrainte de temps crée une tension productive), renseigne contrainte_temps avec un nombre de minutes réaliste (3 à 15 minutes selon la complexité) — un minuteur visuel sera affiché à l'apprenant. Mets contrainte_temps à null quand ce n'est pas pertinent (ex: lecture, réflexion individuelle sans urgence).
