        ...
        <div style={{ display:'flex', alignItems:'flex-end', gap:'12px', height:'160px' }}>
          {data.map((v,i) => (
            <div key={i} style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', gap:'8px' }}>
              ...
              <div style={{ width:'100%', background:'var(--accent-muted)', borderRadius:'6px 6px 0 0', height:`${(v/max)*120}px`, background:'linear-gradient(180deg, var(--accent) 0%, rgba(91,141,239,0.3) 100%)', boxShadow:'0 0 12px rgba(91,141,239,0.3)' }} />
